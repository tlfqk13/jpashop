...
public class OrderServiceTest {
    ...
    public void order() {
        ...
        Book book = createBook("책이름", 100000, 10);
        ...
        assertEquals("상품 주문시 상태는 ORDER", OrderStatus.ORDER, getOrder.getStatus()); // 메세지 기대 실제값
    ...
    public void cancelOrder() {
        //given
        Member member = createMember();
        Item item = createBook("책책책", 10000, 10);
    ...
    public void order_stockException() throws Exception {
        //given
        Member member = createMember();
        Item item = createBook("책책책", 10000, 10);
